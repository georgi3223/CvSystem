@extends('layouts.app') @section('content') <div class="p-6">
 ...
 <form action="{{ route('report.generate') }}" method="POST" class="mt-4"> @csrf <div class="mb-4 w-1/4">
  ...
  <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600"> Generate Report </button>
 </form>
</div> @endsection